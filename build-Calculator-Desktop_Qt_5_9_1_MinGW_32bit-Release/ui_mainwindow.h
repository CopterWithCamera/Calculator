...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_Status->setGeometry(QRect(480, 10, 111, 461));
        ...
        label_ModeValue->setGeometry(QRect(10, 50, 91, 41));
        QFont font;
        ...
        label_All_OutValue->setGeometry(QRect(10, 260, 91, 41));
        ...
        label_All_Out->setGeometry(QRect(10, 240, 91, 16));
        ...
        label_UltraStatusValue->setGeometry(QRect(10, 330, 91, 41));
